...
if st.button("Analyse"):
    if user_input:
        ...
        if y_new == 1:
            ...
            st.write("**Your text suggests that you may be experiencing stress**. It's essential to prioritize self-care.Don't hesitate to reach out to friends or professionals for support. Additionally, consider exploring the resources available on our website[website](https://serenemindz.netlify.app/)")
        st.write("**Disclaimer** : \n")
